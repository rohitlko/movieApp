...
import com.example.android.movieapp.Repo.MovieApiModule_ProvideInterceptorFactory;
import com.example.android.movieapp.Repo.MovieApiModule_ProvideMoshiFactory;
import com.example.android.movieapp.Repo.MovieApiModule_ProvideRetrofitFactory;
import com.example.android.movieapp.Repo.MovieApiModule_ProvideWeatherApiClientFactory;
import com.example.android.movieapp.Repo.MovieApiModule_ProvidesMovieApiFactory;
import com.example.android.movieapp.Repo.MovieRepository;
import com.example.android.movieapp.Repo.MovieRepository_Factory;
import com.example.android.movieapp.service.MovieService;
import com.example.android.movieapp.ui.MainActivity;
import com.example.android.movieapp.ui.MainActivity_MembersInjector;
import com.example.android.movieapp.ui.MainViewModel;
import com.example.android.movieapp.ui.MainViewModel_Factory;
import com.example.android.movieapp.ui.ViewModelFactory;
import com.example.android.movieapp.ui.ViewModelFactory_Factory;
import com.example.android.movieapp.ui.moviesList.MovieListFragment;
import com.example.android.movieapp.ui.moviesList.MovieListFragment_MembersInjector;
...
public final class DaggerAppComponent implements AppComponent {
  ...
  private Provider<MovieService> providesMovieApiProvider;
  ...
  private void initialize(final MovieApiModule movieApiModuleParam) {
    ...
    this.providesMovieApiProvider = DoubleCheck.provider(MovieApiModule_ProvidesMovieApiFactory.create(movieApiModuleParam, provideRetrofitProvider));
    this.movieRepositoryProvider = MovieRepository_Factory.create(providesMovieApiProvider);
